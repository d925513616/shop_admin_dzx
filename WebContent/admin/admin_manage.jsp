<%@ page language="java" import="com.beans.*,com.utils.PageInfo,java.util.*" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
		...
		<tr>
			...
			<td>
				<c:if test="${admin.state=='2'}">
					<a href="AdminServlet.do?flag=js&pageIndex=${page.pageIndex }&id=${admin.id }">解除锁定</a> |
				</c:if>
				<c:if test="${admin.state=='1'}">
					<a href="AdminServlet.do?flag=sd&pageIndex=${page.pageIndex }&id=${admin.id }">锁定</a> |  
