...
注册日期从:<input type="text" class="txtbox" onclick="WdatePicker()" id="startTime" name="startTime" value="${param.startTime}"/> 
到:<input type="text" class="txtbox" onclick="WdatePicker()" id="endTime" name="endTime" value="${param.endTime }"/> 
